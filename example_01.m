...
sys.R  = [0.05; 0.05; 0.02];   % droop (pu speed / pu power) ~ 5%
...
sys.Xd   = [1.80; 1.90; 1.70];
sys.Xq   = [1.70; 1.80; 1.70];
sys.Xdp  = [0.30; 0.25; 0.20];   # already used in classical
sys.Xqp  = [0.55; 0.50; 0.50];
sys.Td0p = [8.0; 6.5; 7.0];
sys.Tq0p = [0.4; 0.5; 0.4];
